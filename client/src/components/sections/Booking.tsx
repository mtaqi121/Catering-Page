...
//         );
//         window.location.href = `mailto:mtaqibagla@gmail.com?subject=${subject}&body=${body}`;
...
export function Booking() {
  ...
  function onSubmit(data: FormValues) {
    createReservation(data, {
      onSuccess: () => {
        const phoneNumber = "923043635628"; // WhatsApp number (country code ke sath)
          ...
          <div className="hidden lg:block lg:col-span-2 bg-primary/5 p-12 flex flex-col justify-between">
            <div>
              ...
              <p className="text-white/60 font-light">
                ...
                your celebration and deliver exceptional service right to your
                venue.
              </p>
            </div>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-white/80 uppercase text-xs">
                            Full Name
                          </FormLabel>
                          <FormControl>
                            <Input
